...
const Header = () => {
  return (
    <div className='bg-[#2A254B] text-amber-300 py-4 sticky top-0'>
      {/* Links for larger screens */}
      <div className='hidden lg:flex lg:justify-between gap-4 md:gap-96 lg:ml-14 ml-4 lg:mr-14'>
        <div className='font-bold lg:text-2xl font-serif'>BLOG Sphere</div>
      ...
      <div className="flex lg:hidden items-center justify-between mr-2 ml-2">
        {/* Blog Name and Icons */}
        <div className="font-bold text-amber-300 font-serif">BLOG Sphere</div>
